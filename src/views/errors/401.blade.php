<x-guest-layout>
	...
	<div class="flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100 dark:bg-gray-900">
    	<div class="w-full sm:max-w-md px-6 py-4 bg-white dark:bg-gray-800 shadow-md overflow-hidden sm:rounded-lg justify-center">
    		...
    		<div class="flex max-w-sm mb-4">
			  ...
			  <div class="font-bold ml-3"> 
			  	<a href="/login">{{ __('Изтекла сесия. Към страницата за вход') }}</a>
			</div>
		</div>
	</div>
</x-guest-layout>
